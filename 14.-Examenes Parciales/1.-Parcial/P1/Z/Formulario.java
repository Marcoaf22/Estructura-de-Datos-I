...
public class Formulario extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int nro = Integer.parseInt(jTextField2.getText().toString());
        int hor = jComboBox1.getSelectedIndex() + 1;
        int min = jComboBox2.getSelectedIndex();
        a.insertar(nro, hor, min, jRbsi.isSelected(), nom, jRadioButton1.isSelected(), jRadioButton2.isSelected(), jRadioButton3.isSelected(), jRadioButton4.isSelected(), jRadioButton5.isSelected(), jRadioButton6.isSelected(), jRadioButton7.isSelected());
